...
fun ResultsScreen(
    ...
    // Persist this quiz attempt to Room — fires exactly once per screen visit
    LaunchedEffect(userViewModel.currentUserId) {
        val uid = userViewModel.currentUserId ?: return@LaunchedEffect
        resultsViewModel.saveAttemptOnce(uid, topic, answers)
    }
